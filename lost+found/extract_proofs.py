...
Extracts raw post_content for all 188 'proof' posts from the WordPress SQL
dump and writes them as HTML files into raw-data/proofs/.
...
def main():
    ...
    posts = parse(sql)
    print(f"Found {len(posts)} proof posts")
