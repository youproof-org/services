...
Extracts raw post_content for all 189 'theorem' posts from the WordPress SQL
dump and writes them as HTML files into raw-data/theorems/.
...
def main():
    ...
    posts = parse(sql)
    print(f"Found {len(posts)} theorem posts")
